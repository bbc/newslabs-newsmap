!function() {
        ...
        function e(n, t, e, r) {
            for (var u, i, o, a = 0, c = t.length, s = e.length; c > a;) {
                ...
                if (u = t.charCodeAt(a++), 37 === u) {
                    if (o = t.charAt(a++), i = N[o in ec ? t.charAt(a++): o], !i || (r = i(n, e, r)) < 0)
                        return - 1
        ...
        function e(n) {
            ...
            return {
                ...
                point: function(f, h) {
                    ...
                    if (!e && (s = c = v) && n.lineStart(), v !== c && (g = r(e, p), (me(e, g) || me(p, g)) && (p[0] += ka, p[1] += ka, v = t(p[0], p[1]))), v !== c)
    ...
    function Rr(n) {
        ...
        if (Vc.insert(t, c), t || e) {
            if (t === e)
                return Yr(t), e = Lr(t.site), Vc.insert(c, e), c.edge = e.edge = Xr(t.site, c.site), Or(t), Or(e), void 0;
            if (!e)
    ...
    function fu(n, t) {
        ...
        for (n += "", t += ""; (e = Gc.exec(n)) && (r = Kc.exec(t));)(u = r.index) 
            > i && (u = t.substring(i, u), a[o] ? a[o] += u : a[++o] = u), (e = e[0]) === (r = r[0]) ? a[o] ? a[o] += r : a[++o] = r : (a[++o] = null, c.push({
                i: o,
                x: lu(e, r)
            })), i = Kc.lastIndex;
    ...
    function Po(n, t, e, r) {
        ...
        if (!i) {
            ...
            i = u[e] = {
                ...
                function o(r) {
                    return u.active > e ? s(!1) : (u.active = e, i.event && i.event.start.call(n, h, t), i.tween.forEach(function(e, r) {
                        (r = r.call(n, h, t)) && v.push(r)
                    }), l = i.ease, f = i.duration, Zo.timer(function() {
                ...
                function c(t) {
                    if (u.active !== e)
                        return s(!1);
                    for (var r = t / f, i = l(r), o = v.length; o > 0;)
                        v[--o].call(n, i);
                    return r >= 1 ? s(!0) : void 0
                }
                function s(r) {
                    return i.event && i.event[r ? "end": "interrupt"].call(n, h, t), --u.count ? delete u[e] : delete n.__transition__, 1
                }
                var l, f, h = n.__data__, g = i.delay, p = Ba, v = [];
                return p.t = g + a, r >= g ? o(r - g) : (p.c = o, void 0)
            }, 0, a)
        }
    }
    function Uo(n, t) {
    ...
    Zo.nest = function() {
        function n(t, a, c) {
            ...
            for (var s, l, f, h, g =- 1, p = a.length, v = i[c++], d = new o; ++g < p;)(h = d.get(s = v(l = a[g]))
                ) ? h.push(l) : d.set(s, [l]);
    ...
    pa.select = function(n) {
        ...
        for (var u =- 1, i = this.length; ++u < i;)
            for (var o = this[u], a =- 1, c = o.length; ++a < c;)(e = o[a]) 
                && (r.push(t = Xo(n.call(e, e.__data__, a, u))), t.parentNode = e);
        return _(r)
    };
    var va = {
    ...
    Zo.ns = {
        ...
        if (!arguments.length) {
            for (n = new Array(a = (r = this[0]).length); ++i < a;)(u = r[i]) 
                && (n[i] = u.__data__);
            return n
        }
        var c = U([]), s = _([]), l = _([]);
    ...
    Zo.interpolateZoom = function(n, t) {
        ...
        function n(n) {
            n.on(C, s).on(Ra + ".zoom", f).on("dblclick.zoom", h).on(L, l)
        }
        function t(n) {
        ...
        function s() {
            ...
            function e() {
                f.on(N, null).on(z, null), g(l && Zo.event.target === i), c(s)
            }
            var r = this, i = Zo.event.target, s = T.of(r, arguments), l = 0, f = Zo.select(Wo).on(N, n).on(z, e), h = t(Zo.mouse(r)), g = I();
            H.call(r), o(s)
        }
        function l() {
            function n() {
            ...
            function f() {
                ...
                Zo.selectAll(b).on(x, null), w.on(C, s).on(L, l), k(), c(p)
            }
            var h, g = this, p = T.of(g, arguments), v = {}, d = 0, x = ".zoom-" + Zo.event.changedTouches[0].identifier, M = "touchmove" + x, _ = "touchend" + x, b = [], w = Zo.select(g).on(C, null).on(L, e), k = I();
            H.call(g), e(), o(p)
        }
        function f() {
        ...
        function h() {
            var n = T.of(this, arguments), e = Zo.mouse(this), i = t(e), s = Math.log(S.k) / Math.LN2;
        ...
        var g, p, v, d, m, x, _, b, w, S = {
            ...
            y: 0,
            k: 1
        }, k = [960, 500], E = qa, A = 0, C = "mousedown.zoom", N = "mousemove.zoom", z = "mouseup.zoom", L = "touchstart.zoom", T = M(n, "zoomstart", "zoom", "zoomend");
    ...
    Zo.interpolateTransform = Du, Zo.layout = {}, Zo.layout.bundle = function() {
        ...
        return a.tick = function() {
            ...
            if (g)
                for (Vu(t = Zo.geom.quadtree(m), r, o)
                    , e =- 1;
            ++e < _;
    ...
    Cs.call = pa.call, Cs.empty = pa.empty, Cs.node = pa.node, Cs.size = pa.size, Zo.transition = function(n) {
        ...
        for (var o =- 1, a = this.length; ++o < a;) {
            ...
            for (var c = this[o], s =- 1, l = c.length; ++s < l;)(r = c[s]) 
                && (e = n.call(r, r.__data__, s, o)) ? ("__data__"in r && (e.__data__ = r.__data__), Po(e, s, u, r.__transition__[u]), t.push(e)) : t.push(null)
        }
        return qo(i, u)
        ...
        if (arguments.length < 2) {
            ...
            P(this, function(r) {
                ...
                (u.event || (u.event = Zo.dispatch("start", "end", "interrupt"))).on(n, t)
            });
        return this
        ...
        for (var n, t, e, r, u = this.id, i=++Ns, o = [], a = 0, c = this.length; c > a; a++) {
            ...
            for (var t = this[a], s = 0, l = t.length; l > s; s++)(e = t[s]) 
                && (r = Object.create(e.__transition__[u]), r.delay += r.duration, Po(e, s, i, r)), n.push(e)
        }
        return qo(o, i)
    ...
    Zo.svg.brush = function() {
        ...
        function u() {
            ...
            if (Zo.event.changedTouches ? L.on("touchmove.brush", v).on("touchend.brush", m) : L.on("mousemove.brush", v).on("mouseup.brush", m), S.interrupt().selectAll("*").interrupt(), C)
